...
public class OnOffStatusActivity extends InterfaceActivity {
    @Override
    protected void generatePropertyView(InterfaceActivity.CustomView properties, CustomView methods) {
        View onOffStatusView = new ReadOnlyValuePropertyView(this, this.intf, "OnOff", null);
        properties.addView(onOffStatusView);
    }
}

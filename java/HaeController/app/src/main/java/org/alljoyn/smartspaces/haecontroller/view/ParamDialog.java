...
public class ParamDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.rootView = (ViewGroup) findViewById(R.id.body);
        int idx = 0;
                ...
                if (listener != null) {
                    ...
                    for (int i = 0; i < ParamDialog.this.valueViews.length; i++) {
                        if (ParamDialog.this.valueViews[i].getText().toString().isEmpty()) {
                            Toast.makeText(ParamDialog.this.getContext(), "Fill all Parameter", Toast.LENGTH_LONG).show();
                            return;
                        }
    ...
    public ParamDialog(Context context, String methodName, Class<?>[] paramTypes,
                       OnOkClickListener listener) {
        this(context, methodName, paramTypes, null, listener);
    }
}
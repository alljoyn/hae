...
public class MinMaxSeekBar extends LinearLayout {
    ...
    public interface OnMinMaxSeekBarChangeListener {
        ...
        void onProgressChanged(SeekBar seekBar, double value, boolean fromUser);
    ...
    SeekBar.OnSeekBarChangeListener seekBarListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            if (MinMaxSeekBar.this.listener != null)
                MinMaxSeekBar.this.listener.onProgressChanged(seekBar, progress * MinMaxSeekBar.this.step + MinMaxSeekBar.this.min, fromUser);
        }

        @Override
        public void onStartTrackingTouch(SeekBar seekBar) {
            if (MinMaxSeekBar.this.listener != null)
                MinMaxSeekBar.this.listener.onStartTrackingTouch(seekBar);
        }

        @Override
        public void onStopTrackingTouch(SeekBar seekBar) {
            if (MinMaxSeekBar.this.listener != null)
                MinMaxSeekBar.this.listener.onStopTrackingTouch(seekBar);
        }
    };

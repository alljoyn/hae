    ...
    private AboutListener m_aboutListener = new AboutListener() {
        ...
        public void announced(String busName, int version, short port, AboutObjectDescription[] aboutObjectDescriptions, Map<String, Variant> aboutData) {
            ...
            try {
                ...
                UUID appId = byteArrayToUUID(byteUUID);
                Device device = new DeviceImpl(DeviceManagerImpl.this.bus, appId, busName, version, port, aboutObjectDescriptions, aboutData);
        ...
        private UUID byteArrayToUUID(byte[] var0) {
            long var1 = 0L;
            long var3 = 0L;

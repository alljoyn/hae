...
public class DeviceInfoAdapter extends ArrayAdapter<Device>
{
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        TextView name = (TextView) m_rowView.findViewById(R.id.sa_item_info_name);
        TextView description = (TextView) m_rowView.findViewById(R.id.sa_item_info_description);

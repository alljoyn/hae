...
import org.alljoyn.smartspaces.operation.AudioVolume;
...
public class DeviceImpl implements Device {
    ...
    private int version;
    private short port;
    private DeviceTypeDescription[] deviceTypeDescriptions = null;
    ...
    public DeviceImpl(BusAttachment bus, UUID deviceId, String busName, int version, short port, AboutObjectDescription[] aboutObjectDescriptions, Map<String, Variant> aboutData) {
        this.bus = bus;
        this.id = deviceId;
    ...
    public DeviceTypeDescription[] getDeviceTypeDescriptions() {
        if (this.deviceTypeDescriptions == null) {
            try {
                this.deviceTypeDescriptions = (DeviceTypeDescription[]) aboutData.get(AboutDataKeys.DEVICE_TYPE_DESCRIPTION).getObject(DeviceTypeDescription[].class);
            } catch (BusException e) {
                e.printStackTrace();
                return null;
            }
        }
        return this.deviceTypeDescriptions;
    }

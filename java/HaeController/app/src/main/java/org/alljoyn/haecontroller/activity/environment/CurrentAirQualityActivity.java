...
public class CurrentAirQualityActivity extends InterfaceActivity {
    ...
    protected void generatePropertyView(CustomView properties, CustomView methods) {
        View contaminantTypeView = new ReadOnlyValuePropertyView(this, this.intf, "ContaminantType", null);
        properties.addView(contaminantTypeView);

        View currentValueView = new ReadOnlyValuePropertyView(this, this.intf, "CurrentValue", null);
        properties.addView(currentValueView);

        View maxValueView = new ReadOnlyValuePropertyView(this, this.intf, "MaxValue", null);
        properties.addView(maxValueView);

        View minValueView = new ReadOnlyValuePropertyView(this, this.intf, "MinValue", null);

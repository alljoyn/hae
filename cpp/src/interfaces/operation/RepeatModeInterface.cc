...
"        <annotation name='org.alljoyn.Bus.DocString.En' value='Interface that exposes On/Off control of device's Repeat mode. When the repeat mode is on, the device repeats its operation.'/>"
...
"            <annotation name='org.alljoyn.Bus.DocString.En' value='True if the device works in repeat mode.'/>"

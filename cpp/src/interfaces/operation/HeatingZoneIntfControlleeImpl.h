...
class HeatingZoneIntfControlleeImpl : public InterfaceControllee, public HeatingZoneIntfControllee {
  public:
     ...
     */
    virtual const uint8_t GetNmberOfHeatingZones() const { return m_numberOfHeatingLevels; }
     ...
     */
    virtual QStatus SetNmberOfHeatingZones(const uint8_t numberOfZones);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetMaxHeatingLevels(std::vector<uint8_t> maxHeatingLevels);
     ...
     * @return ER_OK on success
     */
    virtual QStatus SetHeatingLevels(std::vector<uint8_t> heatingLevels);

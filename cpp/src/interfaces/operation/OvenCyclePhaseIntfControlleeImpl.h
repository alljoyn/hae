...
class OvenCyclePhaseIntfControlleeImpl : public InterfaceControllee, public OvenCyclePhaseIntfControllee {
  public:
    ...
    virtual const OvenCyclePhase GetCyclePhase() const { return m_cyclePhase; }

    virtual QStatus SetCyclePhase(const OvenCyclePhase cyclePhase);

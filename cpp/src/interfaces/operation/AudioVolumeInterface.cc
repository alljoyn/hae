...
"        <annotation name='org.alljoyn.Bus.DocString.En' value='This interface provides capabilities to control and monitor volume.'/>"
...
"            <annotation name='org.alljoyn.Bus.DocString.En' value='Speaker volume index of the device.'/>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
"        <property name='MaxVolume' type='y' access='read'>"
"            <annotation name='org.alljoyn.Bus.DocString.En' value='Maximum value allowed for Volume.'/>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
"        <property name='Mute' type='b' access='readwrite'>"
"            <annotation name='org.alljoyn.Bus.DocString.En' value='If true, state of volume is muted.'/>"
"            <annotation name='org.freedesktop.DBus.Property.EmitsChangedSignal' value='true'/>"
"        </property>"
"    </interface>"
"</node>"

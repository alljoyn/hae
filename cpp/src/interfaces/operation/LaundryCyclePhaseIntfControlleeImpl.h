...
class LaundryCyclePhaseIntfControlleeImpl : public InterfaceControllee, public LaundryCyclePhaseIntfControllee {
  public:
    ...
    virtual const LaundryCyclePhase GetCyclePhase() const { return m_cyclePhase; }

    virtual QStatus SetCyclePhase(const LaundryCyclePhase cyclePhase);
  ...
  private:
    ...
    LaundryCyclePhase m_cyclePhase;

...
QStatus AlertsListener::OnGetAlertCodesDescription(qcc::String& language, AlertsInterface::AlertCodesDescription& description, ErrorCode& error)
{
...
QStatus AlertsListener::OnAcknowledgeAlert(uint16_t alertCode, ErrorCode& error)
{
    QStatus status = ER_OK;

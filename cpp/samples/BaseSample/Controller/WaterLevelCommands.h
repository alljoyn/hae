...
class WaterLevelListener : public WaterLevelIntfControllerListener{
  public:
    ...
    virtual void OnGetSupplySourcePropertyCallback (QStatus status, const qcc::String& objectPath, const uint8_t value, void* context);
    ...
    virtual void SupplySourceProprtyChanged(const qcc::String& objectPath, const uint8_t value);
};

...
class DishWashingCyclePhaseListener : public DishWashingCyclePhaseIntfControllerListener{
  public:
    ...
    virtual void OnResponseGetCyclePhase(QStatus status, const qcc::String& objectPath, const DishWashingCyclePhaseInterface::DishWashingCyclePhase& cyclePhase, void* context);
    ...
    virtual void OnCyclePhasePropertyChanged(const qcc::String& objectPath, const DishWashingCyclePhaseInterface::DishWashingCyclePhase cyclePhase);

...
void OvenCyclePhaseListener::OnResponseGetCyclePhase(QStatus status, const qcc::String& objectPath, const OvenCyclePhaseInterface::OvenCyclePhase& cyclePhase, void* context)
{
    cout << __func__ << endl;
...
void OvenCyclePhaseListener::OnCyclePhasePropertyChanged(const qcc::String& objectPath, const OvenCyclePhaseInterface::OvenCyclePhase cyclePhase)
{
    cout << __func__ << endl;
    cout << "# path: " << objectPath << endl;
    cout << "# cyclePhase: " << (int)cyclePhase << endl;

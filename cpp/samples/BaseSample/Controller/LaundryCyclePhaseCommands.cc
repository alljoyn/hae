...
void LaundryCyclePhaseListener::OnResponseGetCyclePhase(QStatus status, const qcc::String& objectPath, const LaundryCyclePhaseInterface::LaundryCyclePhase& cyclePhase, void* context)
{
    cout << __func__ << endl;
...
void LaundryCyclePhaseListener::OnCyclePhasePropertyChanged(const qcc::String& objectPath, const LaundryCyclePhaseInterface::LaundryCyclePhase cyclePhase)
{
    cout << __func__ << endl;
    cout << "# path: " << objectPath << endl;
    cout << "# cyclePhase: " << (int)cyclePhase << endl;

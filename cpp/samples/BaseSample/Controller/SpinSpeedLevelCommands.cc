...
void SpinSpeedLevelCommands::Init()
{
    ...
    RegisterCommand(&SpinSpeedLevelCommands::OnCmdGetMaxLevel, "gml", "get max soil level");
    RegisterCommand(&SpinSpeedLevelCommands::OnCmdGetTargetLevel, "gtl", "get target soil level");
    RegisterCommand(&SpinSpeedLevelCommands::OnCmdSetTargetLevel, "stl", "set target soil level");

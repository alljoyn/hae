...
class CycleControlListener : public CycleControlIntfControllerListener{
  public:
    ...
    virtual void GetOperationalStatePropertyCallback(QStatus status, const qcc::String& objectPath, const uint8_t state, void* context);
    ...
    virtual void OperationalStatePropertyChanged(const qcc::String& objectPath, const uint8_t state);

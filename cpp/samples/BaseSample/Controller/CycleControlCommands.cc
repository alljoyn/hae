...
void CycleControlListener::GetSupportedStatesPropertyCallbalck(QStatus status, const qcc::String& objectPath, CycleControlInterface::SupportedOperationalStates states, void* context)
{
    cout << __func__ << endl;
    cout << "# status: " << QCC_StatusText(status) << endl;
    cout << "# path: " << objectPath << endl;
...
void CycleControlListener::GetSupportedCommandsPropertyCallbalck(QStatus status, const qcc::String& objectPath, CycleControlInterface::SupportedOperationalCommands commands, void* context)
{
    cout << __func__ << endl;
    cout << "# status: " << QCC_StatusText(status) << endl;
    cout << "# path: " << objectPath << endl;
...
void CycleControlListener::SupportedOperationalStatesProperyChanged(const qcc::String& objectPath, CycleControlInterface::SupportedOperationalStates states)
{
    cout << __func__ << endl;
    cout << "# path: " << objectPath << endl;
    cout << "# supported states: " << endl;
...
void CycleControlListener::SupportedOperationalCommandsProperyChanged(const qcc::String& objectPath, CycleControlInterface::SupportedOperationalCommands commands)
{
    cout << __func__ << endl;
    cout << "# path: " << objectPath << endl;
    cout << "# supported commands: " << endl;

...
void DishWashingCyclePhaseListener::OnResponseGetCyclePhase(QStatus status, const qcc::String& objectPath, const DishWashingCyclePhaseInterface::DishWashingCyclePhase& cyclePhase, void* context)
{
    cout << __func__ << endl;
...
void DishWashingCyclePhaseListener::OnCyclePhasePropertyChanged(const qcc::String& objectPath, const DishWashingCyclePhaseInterface::DishWashingCyclePhase cyclePhase)
{
    cout << __func__ << endl;
    cout << "# path: " << objectPath << endl;
    cout << "# cyclePhase: " << (int)cyclePhase << endl;

...
{
    m_heatingZoneIntfControllee->SetNmberOfHeatingZones(4);
    uint8_t numZones = m_heatingZoneIntfControllee->GetNmberOfHeatingZones();
...
int main()
{
    ...
    //TVControllee
    BusAttachment* bus = new BusAttachment("CookTop", true);
    if (!bus) {

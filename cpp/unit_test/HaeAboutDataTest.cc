...
TEST(HaeAboutDataTest, DISABLED_VerifyFieldValues) {
...
TEST(HaeAboutDataTest, DISABLED_SetDeviceTypeDescription) {
    QStatus status = ER_FAIL;
    HaeAboutData aboutData("en");
...
TEST(HaeAboutDataTest, DISABLED_IsValid)
{
    QStatus status = ER_FAIL;
    HaeAboutData aboutData("en");
...
TEST(HaeAboutDataTest, DISABLED_IsValid_Negative)
{
    QStatus status = ER_FAIL;
    HaeAboutData aboutData;
...
TEST(HaeAboutDataTest, DISABLED_GetMsgArg_es_language)
{
    QStatus status = ER_FAIL;
    HaeAboutData aboutData("en");
...
TEST(HaeAboutDataTest, DISABLED_GetAnnouncedAboutData)
{
    QStatus status = ER_FAIL;
    HaeAboutData aboutData("en");
...
TEST(HaeAboutDataTest, DISABLED_InitUsingMsgArg)
{
    QStatus status = ER_FAIL;
    HaeAboutData aboutData("en");
 ...
 */
TEST(HaeAboutDataTest, DISABLED_CreateFromXml_from_char_string) {
    QStatus status = ER_FAIL;
    HaeAboutData aboutData;
    const char* xml =
        "<AboutData>"

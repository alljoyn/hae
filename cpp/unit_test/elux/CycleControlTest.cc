...
TEST_F(HAETest, HAE_v1_11)
{
    ...
    for (size_t i = 0; i < m_interfaces.size(); i++) {
        ...
        const CycleControlInterface::CycleControlOperationalCommand invalidCommand = CycleControlInterface::CycleControlOperationalCommand::OPERATIONAL_COMMAND_PAUSE;

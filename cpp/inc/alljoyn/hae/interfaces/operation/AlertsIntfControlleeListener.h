...
class AlertsIntfControlleeListener : public InterfaceControlleeListener {
  public:
     ...
     * @return ER_OK on success
     */
    virtual QStatus OnGetAlertCodesDescription(qcc::String& language, AlertsInterface::AlertCodesDescription& description, ErrorCode& error) = 0;
     ...
     * @return ER_OK on success
     */
    virtual QStatus OnAcknowledgeAlert(uint16_t alertCode, ErrorCode& error) = 0;

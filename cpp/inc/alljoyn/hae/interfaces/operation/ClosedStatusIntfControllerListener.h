...
class ClosedStatusIntfControllerListener : public InterfaceControllerListener {
  public:
    ...
    /*
     * TODO: define set/get property callback
     */
    /**
     ...
     * @param[in] context the context that is passed from application
     */
    //virtual void SetIsClosedPropertyCallback(QStatus status, const qcc::String& objectPath, void* context) {}
    ...
    /*
     * TODO: define PropertyChanged and other signals
     */

...
class CycleControlIntfControllerListener : public InterfaceControllerListener {
  public:
     ...
     * @param[in] context the context that is passed from application
     */
    virtual void GetSupportedStatesPropertyCallbalck(QStatus status, const qcc::String& objectPath, CycleControlInterface::SupportedOperationalStates& states, void* context) {}
     ...
     * @param[in] context the context that is passed from application
     */
    virtual void GetSupportedCommandsPropertyCallbalck(QStatus status, const qcc::String& objectPath, CycleControlInterface::SupportedOperationalCommands& commands, void* context) {}
     ...
     * @param[in] states The list of states
     */
    virtual void SupportedOperationalStatesProperyChanged(const qcc::String& objectPath, CycleControlInterface::SupportedOperationalStates& states) {}
     ...
     * @param[in] commands The list of commands
     */
    virtual void SupportedOperationalCommandsProperyChanged(const qcc::String& objectPath, CycleControlInterface::SupportedOperationalCommands& commands) {}

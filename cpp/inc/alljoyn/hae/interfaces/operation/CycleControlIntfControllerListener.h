...
class CycleControlIntfControllerListener : public InterfaceControllerListener {
  public:
     ...
     */
    virtual void GetOperationalStatePropertyCallback(QStatus status, const qcc::String& objectPath, const uint8_t currentState, void* context) {}
     ...
     * @param[in] context the context that is passed from application
     */
    virtual void GetSupportedStatesPropertyCallbalck(QStatus status, const qcc::String& objectPath, SupportedOperationalStates states, void* context) {}
     ...
     * @param[in] context the context that is passed from application
     */
    virtual void GetSupportedCommandsPropertyCallbalck(QStatus status, const qcc::String& objectPath, SupportedOperationalCommands commands, void* context) {}
     ...
     * @param[in] currentState current state
     */
    virtual void OperationalStatePropertyChanged(const qcc::String& objectPath, const uint8_t currentState) {}
     ...
     * @param[in] states The list of states
     */
    virtual void SupportedOperationalStatesProperyChanged(const qcc::String& objectPath, SupportedOperationalStates states) {}
     ...
     * @param[in] commands The list of commands
     */
    virtual void SupportedOperationalCommandsProperyChanged(const qcc::String& objectPath, SupportedOperationalCommands commands) {}

...
AJ_Status OnGetVolume2(const char* objPath, uint8_t* volume)
{
    printf("OnGetVolume2 : %s\n", objPath);
...
AJ_Status OnGetMute2(const char* objPath, bool* mute)
{
    printf("OnGetMute2 : %s\n", objPath);
...
AJ_Status InitHaeProperties(AJ_BusAttachment* busAttachment)
{
    ...
    uint8_t vol2 = 5;
    uint8_t volRead = 0;
    char channelId[81] = "3333333333";
    char channelId2[101] = "1111111111";
    char channelIdBuf[128];
    uint16_t numOfChannels = 70;

    status = Hae_AudioVolumeInterfaceSetVolume(busAttachment, "/AAAAAAAA", &vol);
    status = Hae_AudioVolumeInterfaceGetVolume("/AAAAAAAA", &volRead);
    printf("volume : %u\n", volRead);
    status = Hae_AudioVolumeInterfaceSetVolume(busAttachment, "/BB", &vol2);

    status = Hae_ChannelInterfaceSetChannelId(busAttachment, "/AAAAAAAA", channelId);
    status = Hae_ChannelInterfaceGetChannelId("/AAAAAAAA", channelIdBuf);
    printf("channelId : %s\n", channelIdBuf);
    status = Hae_ChannelInterfaceSetTotalNumberOfChannels(busAttachment, "/AAAAAAAA", &numOfChannels);
    status = Hae_ChannelInterfaceSetChannelId(busAttachment, "/BB", channelId2);
...
int AJ_Main(void)
{
    ...
    AudioVolumeListener audioVolumeListener2;
    ...
    audioVolumeListener2.OnGetVolume = NULL;
    audioVolumeListener2.OnSetVolume = OnSetVolume;
    audioVolumeListener2.OnGetMaxVolume = OnGetMaxVolume;
    audioVolumeListener2.OnGetMute = NULL;
    audioVolumeListener2.OnSetMute = OnSetMute;
    ...
    status = Hae_CreateInterface(AUDIO_VOLUME_INTERFACE, "/AAAAAAAA", &audioVolumeListener);
    status = Hae_CreateInterface(CHANNEL_INTERFACE, "/AAAAAAAA", &channelListener);
    status = Hae_CreateInterface(AUDIO_VOLUME_INTERFACE, "/BB", &audioVolumeListener2);
    status = Hae_CreateInterface(CHANNEL_INTERFACE, "/BB", &channelListener);

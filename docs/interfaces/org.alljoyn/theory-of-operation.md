...
|Air Purifier|Device that has a filter that removes dust from the air.|OperationControl|
|Electric Fan|Traditional style fan usually with blades visible from outside.|OperationControl|

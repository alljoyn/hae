...
The property values are organized in two ranges:
  ...
  * 0x00-0x7F --- **standard cycle phase** --- the meanings is shared among
    every appliance supporting the Oven interface

  * 0x8000-0xFFFF --- **proprietary cycle phase** --- the meanings depends on
    manufacturer so different appliances can use the same values with different
    meanings

At the moment the list of **standard cycle phases** is still under discussion;
the only standard value is:
...
used to know in advance and which are the values that the **CyclePhase**
property can assume.

The elements of the array belongs to the **standard cycle phase** and
**proprietary cycle phase** ranges. The list can be composed by:
...
#### GetCyclePhasesInfo (languageTag) -> (info)
...
[0x8000 - 0xFFFF] of **CyclePhase** propriety.

...
Optical catalyst might be good for reducing odor or germs.
...
Ion emision might be good for reducing molds, germs or allergens.
...
When powerful mode is on, the effect of purifying air increases.
...
Sleep mode is good for used when the users are sleeping, with, for 
example, less emission of noise or usage or power.

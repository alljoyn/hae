...
values are organized in two ranges.
  ...
  * 0x8000-0xFFFF --- **proprietary cycle id** --- the meanings depend on
...
It is used to communicate to controller the names and descriptions of the
proprietary phases supported by the appliance, so they can be available by the
remote controller.
...
Errors raised by this method:
  ...
  * org.alljoyn.Hae.Device.Error.RemoteControlDisabled --- remote control is
    disabled
  * org.alljoyn.Hae.Device.Error.NotSupported --- turbo mode is not supported
  by device
...
Errors raised by this method:
  ...
  * org.alljoyn.Hae.Device.Error.RemoteControlDisabled --- remote control is
    disabled
  * org.alljoyn.Hae.Device.Error.NotSupported --- repeat mode is not supported
  by device

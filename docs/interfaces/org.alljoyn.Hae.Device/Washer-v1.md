...
The followings are minimum required shared interfaces for Washers.

  * **org.alljoyn.Hae.OperationalControl** --- for monitoring and controlling
  the appliance operational state

Some Washers have also capabilities allowing:
...
![Washer Selection Diagram][WasherSelection-Diagram]

[WasherSelection-Diagram]: WasherSelectionExample.png

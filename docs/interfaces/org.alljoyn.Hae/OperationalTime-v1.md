...
appliance is related, so this interface is linked to OperationalControl
interface
...
following reasons:
  ...
  * since these times are relative, future evolution of the interface can use
    ...
    seconds", "0" means "now", "-10" means "10 second ago", ...

At the moment negative values are used just for special cases, not to express
the past.
...
The following time chart shows how the property can evolve during the operation
selection and execution.

![OperationalTime Graph Example][OperationalTimeGraphExample]

[OperationalTimeGraphExample]: OperationalTimeGraphExample.png
...
## References
  ...
  * The definition of the [OperationalControl interface](OperationalControl-v1)

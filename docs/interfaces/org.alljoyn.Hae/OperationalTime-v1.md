...
past: i.e. in ">0" means "in the future",
"<0" could mean "in the past".
...
The interface
is designed to be included in a higher level device which can
...
![TargetTimeToStart Chart][TargetTimeToStart-chart]

[TargetTimeToStart-chart]: OperationalTime_TargetTimeToStart_chart.png
...
For an example on how the property works, see the below line chart.
![TargetTimeToStop Chart][TargetTimeToStop-chart]

[TargetTimeToStop-chart]: OperationalTime_TargetTimeToStop_chart.png
...
For an example on how the property works, see the below line chart.
![EstimatedTimeToEnd Chart][EstimatedTimeToEnd-chart]

[EstimatedTimeToEnd-chart]: OperationalTime_EstimatedTimeToEnd_chart.png
...
For an example on how the property works, see the below line chart.
![RunningTime Chart][RunningTime-chart]

[RunningTime-chart]: OperationalTime_RunningTime_chart.png
...
For an example on how the property works, see the below line chart.
![TargetDuration Chart][TargetDuration-chart]

[TargetDuration-chart]: OperationalTime_TargetDuration_chart.png
...
Set the TargetTimeToStart propriety to a new value.
...
Set the TargetTimeToStop propriety to a new value.

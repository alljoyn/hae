...
#### GetWaterLevelsDescription (languageTag) -> (waterLevelsDescription)

Get added description about the water levels in string format. It is 
...
Output arguments:
  ...
  * **waterLevelsDescription** --- string[] --- the list of strings

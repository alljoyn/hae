# org.alljoyn.Hae.WaterLevel version 1
...
If **SupplySource** = **Pipe** or **Unknown**, then **Level** shall be always 
**0**, which means there is practically no infomation available about the 
current water level.
...
If **SupplySource** = **Pipe** or **Unknown**, then **MaxLevel** shall be **0**.

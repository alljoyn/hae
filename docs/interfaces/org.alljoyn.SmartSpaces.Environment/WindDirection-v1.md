...
setpoint value is greater than HorizontalMax. Step value for HorizontalDirection is
...
is greater than VerticalMax. Step value for VerticalDirection is always 1.

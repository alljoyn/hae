...
|Freezer             | 2  | Device that stores food at temperatures which are a few degrees below the freezing point of water (typically about -18 ℃), so the food itself is safe indefinitely.| Operation.DoorStatus |
